    ...
    : QDialog(parent)
{
    ...
    QHBoxLayout *dialogControlButtonsLayout = new QHBoxLayout();

    QPushButton *okButton = new QPushButton(tr("OK"));
    QPushButton *cancelButton = new QPushButton(tr("Cancel"));
    dialogControlButtonsLayout->addWidget(okButton);
    dialogControlButtonsLayout->addWidget(cancelButton);
    ...
    mainGroupLayout->addLayout(dialogControlButtonsLayout);
#ifdef QT_OPENGL_SUPPORT
...
QImage GradientDialog::getGradientImage()
{
    QImage image = m_renderer->paintToPixmap();
    return image;
}
...
QImage GradientRenderer::paintToPixmap()
{
    QPixmap pixmap(1024, 100);
    QPainter toPixMapPainter(&pixmap);
    ...
    toPixMapPainter.setBrush(g);
    toPixMapPainter.setPen(Qt::NoPen);

    toPixMapPainter.drawRect(pixmap.rect());
    toPixMapPainter.end();
    pixmap.toImage().save("some.jpg");
